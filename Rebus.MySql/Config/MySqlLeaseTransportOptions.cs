...
{
    /// <summary>
    /// Extends <seealso cref="MySqlTransportOptions"/> with options specific to the <seealso cref="MySqlLeaseTransport"/>
    /// </summary>
    public class MySqlLeaseTransportOptions : MySqlTransportOptions
    {
        /// <summary>
        /// Create an instance of the transport with a pre-created <seealso cref="DbConnectionProvider"/>
        /// </summary>
        public MySqlLeaseTransportOptions(IDbConnectionProvider connectionProvider) : base(connectionProvider)
        {
        }
        ...
        /// </summary>
        public MySqlLeaseTransportOptions(string connectionString, bool enlistInAmbientTransaction = false) : base(connectionString, enlistInAmbientTransaction)
        {
        }
        ...
        /// </summary>
        public MySqlLeaseTransportOptions(Func<Task<IDbConnection>> connectionFactory) : base(connectionFactory)
        {
        }
